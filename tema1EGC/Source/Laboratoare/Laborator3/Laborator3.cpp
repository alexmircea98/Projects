...
void Laborator3::Update(float deltaTimeSeconds)
{
	...
	angularStep += deltaTimeSeconds * 2.0f;
	...
	modelMatrix *=  //Transform2D::Translate(translateX, translateY)
				    Transform2D::Scale(.5, .5)
					* Transform2D::Rotate(angularStep * 3)
					*Transform2D::Translate(500,0)
	...
	modelMatrix *= 
		...
		* Transform2D::Rotate(angularStep * 6)
		* Transform2D::Translate(400, 0)
		* Transform2D::Rotate(angularStep)
		* Transform2D::Translate(-50, -50);
